...
Clock programs.
More info at https://en.wikipedia.org/wiki/seven-segments_display
View this code at https://nostarch.com/big-book-small-python-projects
Tags: short, module"""

"""A labeled seven-segment display, with each segmente labeled A  to G:
 __A__
...
def getSevSegStr(number, minWidth = 0):
    ...
    # Convert number to string in case it's in an in or float:
    ...
    for i, numeral in enumerate(number):
        ...
        elif numeral == '-':  # Render the negativer sign.
            rows[0] += '    '
            rows[1] += ' __ '
            rows[2] += '    '
        elif numeral == '0':  # Render the O.
            rows[0] += ' __ '
            rows[1] += '|  |'
            rows[2] += '|__|'
        ...
        # Add a space (for the space in between numeral) if this
...
# If this program isn't imported, display the number 00 to 99.
if __name__ == '__main__':
    print('This module is meant to be imported rather tand run.')
